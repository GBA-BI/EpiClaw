#!/usr/bin/env python3
"""EpiClaw Recombination Detector -- real-only execution pipeline."""
...
VERSION = "0.1.0"
SKILL_NAME = "recombination-detector"
TOOL_CANDIDATES = ['rdp4', 'rdp', 'hyphy', 'geneconv', 'gubbins']
DEMO_FASTA = """>seq1
ATGCGTACGTAGCTAGCTAGCTAG
>seq2
ATGCGTACGTAGCTAGCTAGTTAG
>seq3
ATGCGTACGTAGATAGCTAGTTAG
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="EpiClaw Recombination Detector -- real execution only.",
    )
...
def _write_demo_input(output_dir: Path) -> Path:
    demo_path = output_dir / "demo_recombination.fasta"
...
def generate_report(output_path: Path, input_path: Path, summary: dict, tool_info: dict) -> None:
    header = generate_report_header(
        title="Recombination Detector Report",
